...
from torsiondrive.qm_engine import EnginePsi4, EngineQChem, EngineTerachem, EngineOpenMM, EngineGaussian, EngineNWChem
...
def create_engine(enginename, inputfile=None, work_queue_port=None, native_opt=False, extra_constraints=None):
    ...
    """
    engine_dict = {'psi4': EnginePsi4, 'qchem': EngineQChem, 'terachem':EngineTerachem, 'openmm': EngineOpenMM, "gaussian": EngineGaussian, "nwchem": EngineNWChem}
